SELECT 
    ...
    SKMD.SKMD_SZK_COD AS SZK_COD, -- 来自SKMD表的SZK_COD
    PHJD.PHJD_KM_COD AS KM_COD,
    PHJD.PHJD_TAS_YDO AS TAS_YDO,
    PPJD.PPJD_KM_COD AS IRS_KM_COD, -- 来自PPJD表的KM_COD作为IRS_KM_COD
    SSKMD.SKMD_SZK_COD AS IRS_SZK_COD, -- 来自别名为SSKMD的SKMD表的SZK_COD
...
JOIN
    BGTA2_SKMD SSKMD ON PHJD.PHJD_KM_COD = SSKMD.SKMD_KM_COD
        AND SSKMD.SKMD_KBS_VER_ID = 60 -- 检查这里是否正确关联，可能需要调整
WHERE
