SELECT PHJD.PHJD_KHA_COD AS KHA_COD	
 ...
 INNER JOIN BGTA3_PPJD PPJD1 ON PPJD1.PPJD_KHA_COD = PPJD.PPJD_KHA_COD	
   AND PPJD1.PPJD_SZK_COD = PPJD.PPJD_IRM_SZK_COD	
   AND PPJD1.PPJD_PJ_COD = PPJD.PPJD_IRM_PJ_COD	
 INNER JOIN BGTA2_SKMD MSKMD ON MSKMD.SKMD_KHA_COD = PPJD1.PPJD_KHA_COD	
   AND MSKMD.SKMD_KBS_VER_ID = '60'	
   AND MSKMD.SKMD_KM_COD = PPJD1.PPJD_KM_COD	
