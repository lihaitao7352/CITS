...
FROM
    BGTA2_PHJD PHJD
INNER JOIN
    (SELECT DISTINCT PPJD_KHA_COD, PPJD_KM_COD, PPJD_PJ_COD, PPJD_IRM_PJ_COD
     FROM BGTA3_PPJD
     WHERE PPJD_KHA_COD = '20512'
       AND PPJD_IRM_PJ_COD IS NOT NULL
       AND PPJD_PJ_COD IS NOT NULL) PPJD
ON PPJD.PPJD_KHA_COD = PHJD.PHJD_KHA_COD
...
ON SKMD.SKMD_KHA_COD = PHJD.PHJD_KHA_COD
