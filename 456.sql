...
JOIN BGTA2_SKMD SSKMD ON SSKMD.SKMD_KHA_COD = PPJD.PPJD_KHA_COD
                     AND SSKMD.SKMD_KBS_VER_ID = '60'
                     AND SSKMD.SKMD_KM_COD = PPJD.PPJD_KM_COD
JOIN BGTAZ_PTCD PTCD ON PTCD.PTCD_KHA_COD = PHJD.PHJD_KHA_COD
                     AND PTCD.PTCD_PJ_COD = PHJD.PHJD_PJ_COD
JOIN BGTA2_SKMD SKMD ON SKMD.SKMD_KHA_COD = PHJD.PHJD_KHA_COD
