SELECT 
    ...
    SUM(NVL(PHJD.PHJD_6M_JSC, 0)) AS JSC 6M,
    SUM(NVL(PHJD.PHJD_7M_JSC, 0)) AS JSC 7M,
    SUM(NVL(PHJD.PHJD_8M_JSC, 0)) AS JSC 8M,
    SUM(NVL(PHJD.PHJD_9M_JSC, 0)) AS JSC 9M,
...
WHERE 
    ...
    AND PHJD.PHJD_TAS_YDO = '2023'  -- 日付範囲条件の単純化
