SELECT
    ...
    SKMD2.SKMD_SZK_COD AS SZK_COD,  -- 使用匹配 SQL2 的 SKMD 选择
    PHJD.PHJD_KM_COD AS KM_COD,
    PHJD.PHJD_TAS_YDO AS TAS_YDO,
    PPJD.PPJD_KM_COD AS IRS_KM_COD,  -- 使用匹配 SQL2 的 PPJD 选择
    SKMD2.SKMD_SZK_COD AS IRS_SZK_COD,  -- 使用匹配 SQL2 的 SKMD 选择
...
INNER JOIN
    BGTA2_SKMD SKMD2 ON SKMD2.SKMD_KHA_COD = PHJD.PHJD_KHA_COD
    AND SKMD2.SKMD_KBS_VER_ID = '60'
    AND SKMD2.SKMD_KM_COD = PHJD.PHJD_KM_COD  -- 确保使用与 SQL2 相同的 KM_COD
WHERE
